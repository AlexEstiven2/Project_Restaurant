        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const confirm = await Swal.fire({
                    title: '¿Liberar mesa?',
                    text: "Se finalizará la cuenta y el historial del menú digital quedará limpio para el próximo cliente.",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Sí, liberar y finalizar',
                    confirmButtonColor: '#000000',
                ...
                if (confirm.isConfirmed) {
                    try {
                        ...
                        if (!responseFinalizar.ok) throw new Error("No se pudieron finalizar los pedidos");
                        ...
                        console.error("Error en el proceso de liberación:", error);
