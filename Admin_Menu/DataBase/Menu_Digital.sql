...
CREATE TABLE IF NOT EXISTS MESAS (
    ...
    ESTADO_MESA ENUM(
        'DISPONIBLE', 'OCUPADA', 'LLAMANDO MESERO', 
        'ESPERANDO PEDIDO', 'PEDIDO EN MESA', 'PAGANDO', 'PIDIENDO FACTURA', 'PAGO CONFIRMADO', 'ELIMINADA'
    ) DEFAULT 'DISPONIBLE',
...
CREATE TABLE IF NOT EXISTS PEDIDOS (
    ...
    ESTADO_PEDIDO ENUM('PENDIENTE','EN_PREPARACION','CANCELADO','ENTREGADO', 'FINALIZADO') DEFAULT 'PENDIENTE',
    ID_MESA INT,
...
-- INSERTS DE DATOS DEL MENU

-- CATEGORIAS
INSERT INTO CATEGORIAS (IMAGEN, NOMBRE_CATE, ESTADO_CATE) VALUES ('Postres.jpg', 'Postres', 'DISPONIBLE')